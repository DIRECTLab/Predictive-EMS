...
class Agent:
    def __init__(self):
        ...
        self.eps_decay = 5000 # Perfect for 100_000 iterations
        self.tau = 0.005
        self.lr = 1e-4
        self.steps_taken = 0
    ...
    def optimize_model(self):
        ...
        intermediate = self.policy_net(state_batch)
...
def run():
    ...
    for epoch in tqdm(range(num_epochs)):
        ...
        random_start_location = random.randint(0, len(data) - seq_length - 100) # - 100 because most likely, there won't be any charges that take longer than that
