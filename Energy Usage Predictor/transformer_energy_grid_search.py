...
def generate_energy_usage():
    ...
    delta_start = datetime.timedelta(days=10)
...
if __name__ == "__main__":
    ...
    best_lr = 0
    best_num_head = 0
    best_num_encoder_layer = 0
    best_num_decoder_layer = 0
    best_seq_length = 0
                ...
                for num_encoder_layer in num_encoder_layers:
                    for num_decoder_layer in num_decoder_layers:
                        ...
                        if validation_loss[-1] < best_loss:
                            ...
                            best_lr = lr
                            best_num_head = num_head
                            best_num_encoder_layer = num_encoder_layer
                            best_num_decoder_layer = num_decoder_layer
    ...
    with open("best_network.txt", "w") as f:
        f.write(f"The Best Network:\n \tLR: {best_lr}\n\tNum Heads: {best_num_head}\n\tNum Encoder Layers: {best_num_encoder_layer}\n\tNum Decoder Layers: {best_num_decoder_layer}, Sequence Length: {best_seq_length} ")
    ...
    # plt.savefig("energy_predictions_grid_search.jpg")        
